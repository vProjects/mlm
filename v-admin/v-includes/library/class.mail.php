...
class Mail{
		...
		*/	
		...
		/*
			Function to send confirmation of order to the customer with the details
		*/	
		function confirmationOfAddMoney($to,$money_id,$amount){
			$message = '<p><img src="mojlife.com/img/logo.png"></p>
						<h3><span style="color:#0080FF">Money ID: </span>'.$money_id.'</h3>
						
						<p>Your Mojlife account has been credited by €  '.$amount.' </p>
			...
			$sub = 'Confirmation of Add Money From mojlife.com';
			$headers = "From: sales@mojlife.com"."\r\n";
		...
		/*
			Function to send confirmation of order to the customer with the details
		*/	
		function membershipExtendationMail($to,$msg){
			$message = '<p><img src="mojlife.com/img/logo.png"></p>
						<p>'.$msg.'</p>
			...
			$sub = 'Membership Extendation From mojlife.com';
			$headers = "From: sales@mojlife.com"."\r\n";
