...
?>
<?php
	if(isset($GLOBALS['_GET']['product']))
	{
		$product_id = $GLOBALS['_GET']['product'];
	}
    ...
    <div class="row-fluid">
        ...
        <div class="addthis_share_button">    
            ...
            <?php
				...
				if(isset($product_id))
				{
					$getProductDetails = $manageContent->getProductDetails($product_id);
				}
				//if category is selected
				else if(isset($category))
				{
					echo '<h4 class="left_container_heading"><span class="heading_text">'.$category.'</span></h4>';
					$getProducts = $manageContent->getProducts($category);
